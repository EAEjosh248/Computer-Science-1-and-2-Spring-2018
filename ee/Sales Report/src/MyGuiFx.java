/**
 * MvGuiFx, Class representing the GUI for Displaying a DisneyWorld District 5 Sales Report
 * @author Jeannette Kartchner
 */
...
public class MyGuiFx extends Application {;
	...
	public void readFile() throws FileNotFoundException {
		...
		for(col=0;col<columns;col++)
		{
			total = TwoDimRaggedArrayUtility.getLowestInColumn(sales, col);
			TextField temp = new TextField(currencyFormat.format(total));
	...
	private class ButtonEventHandler implements EventHandler<ActionEvent> {
		@SuppressWarnings("restriction")
		@Override
		public void handle(@SuppressWarnings("restriction") ActionEvent e) {
