...
public class TwoDimRaggedArrayUtilityTest {
	...
	private double[][] dataSetSTUDENT = {{-23.5,-512.3,6.1},{-455.4,8.2},{2.335,-724.5},{4.2,7.3,5.9,2.6},{7.2,2.5,9.3,4.8},{5.9},{8.1,1.7,3.3},{11.6,6.9,7.3,2.7}} ;
	...
	public void testGetColumnTotalSTUDENT() {
		assertEquals(-1210.199,TwoDimRaggedArrayUtility.getColumnTotal(dataSetSTUDENT,1),.001);
		assertEquals(-439.565,TwoDimRaggedArrayUtility.getColumnTotal(dataSetSTUDENT,0),.001);
		assertEquals(31.900,TwoDimRaggedArrayUtility.getColumnTotal(dataSetSTUDENT,2),.001);	}
	/**
	...
	public void testGetAverageSTUDENT() {
		assertEquals(-69.9028,TwoDimRaggedArrayUtility.getAverage(dataSetSTUDENT),.001);
	}
	/**
	...
	public void testGetRowTotalSTUDENT() {
		assertEquals(20,TwoDimRaggedArrayUtility.getRowTotal(dataSetSTUDENT,3),.001);
		assertEquals(-447.2,TwoDimRaggedArrayUtility.getRowTotal(dataSetSTUDENT,1),.001);
		assertEquals(-722.165,TwoDimRaggedArrayUtility.getRowTotal(dataSetSTUDENT,2),.001);
	...
	public void testGetHighestInArraySTUDENT() {
		assertEquals(11.6,TwoDimRaggedArrayUtility.getHighestInArray(dataSetSTUDENT),.001);}
}
