...
public interface ShipRegistryInterface {
	 ...
	 * @throws FileNotFoundException : bad file path
	 * @throws IOException : IO error
	 * @throws NumberFormatException : Invalid parse information 
	 */
	 ...
	 */
	public void writeFile(File file) throws FileNotFoundException, IOException, Exception;
